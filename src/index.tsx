...
import { MyFgsDirectoryProps, MyFgsDirectory } from "./my-fgs-directory";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
   ...
   */
  return class MyFgsDirectoryBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): MyFgsDirectoryProps {
...
const blockDefinition: BlockDefinition = {
    name: "my-fgs-directory",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'My Fgs Directory'
};
